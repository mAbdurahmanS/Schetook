...
@section('content')
    ...
    <main>
        <div class="create">
            ...
            <div class="content">
                <h1>Create New Jam Pelajaran</h1>

                <form method="POST" action="/dashboard/jam-pelajaran" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="form-control">
                        <label for="hari">Hari</label>
                        <select name="hari">
                            <option value="{{ old('hari'), $jampelajaran->hari }}">{{ $jampelajaran->hari }}</option>
